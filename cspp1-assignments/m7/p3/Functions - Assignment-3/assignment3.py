...
more slowly, especially in cases with very large balances
...
# is a reasonable lower bound for this payment value? $0 is the obvious anwer, but you
can do better than that. If there was no interest,
...
# the smallest monthly payment to the cent (no more multiples of $10) such that we can
pay off the debt within a year. Try it out with
...
def payingdebtoffinayear(b_i, annual_interestrate):
    '''
    Count the lowest pay using bisection method
    '''
    init_balance = b_i
